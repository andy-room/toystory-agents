...
function _defaultState() {
  return {
    ...
    microContents:    [],
    microSupplements: [],
    offlineConfig:   { attendanceTotal: 1, attendanceRequired: 1 },
    offlineSessions: [],
  ...
  try {
    ...
    return {
      ...
      toc:           Array.isArray(p.toc)           ? p.toc           : d.toc,
        offlineConfig:    Object.assign({}, d.offlineConfig,   p.offlineConfig),
    offlineSessions:  Array.isArray(p.offlineSessions)  ? p.offlineSessions  : d.offlineSessions,
